...
class Customer extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_seller() && ($this->ion_auth->seller_status() == 1 || $this->ion_auth->seller_status() == 0) && get_seller_permission($seller_id, 'customer_privacy')) {
